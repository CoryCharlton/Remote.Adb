...
/// files live: <c>ANDROID_AVD_HOME</c>, else <c>$ANDROID_SDK_HOME/.android/avd</c>, else <c>~/.android/avd</c>.
/// </summary>
public static class AvdHome
{
    /// <summary>The first existing AVD home from the resolution order, or <see langword="null"/>.</summary>
